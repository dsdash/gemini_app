...
// API setup
const API_KEY = "AIzaSyDMwqBxSh7uMggx5EK2ga4U4f5IBmWMb9w";
...
const handleFormSubmit = (e) => {
    ...
    {useData.file.data}" class="img-attachment" />` : `<p class="file-attachment"><span
...
//show/hide controls fot mobile on prompt input focus
...
// const isLightTheme = localStorage.setItem("themeColor") === "light_mode";
